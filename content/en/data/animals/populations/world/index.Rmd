...
```{r animal_populations_data, include=FALSE, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
...
```{r animal_populations, echo=FALSE, message=FALSE, warning=FALSE}
